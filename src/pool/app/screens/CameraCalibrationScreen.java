...
public class CameraCalibrationScreen extends Screen {
	...
	public void update () {
		...
		Imgproc.rectangle(fb, new Point(0, 0), new Point(fb.cols(), fb.rows()), new Scalar(0, 0, 0), -1);
		Imgproc.rectangle(fb, new Point(20, 20), new Point(fb.cols()-40, fb.rows()-20), new Scalar(255, 255, 255), 1);
