...
public class BallsizeCalibration extends Screen {
	...
	public void update () {
		...
		Imgproc.line(result, new Point(startX, startY), new Point(endX, endY), new Scalar(0, 255, 0));
		...
		Imgproc.putText(result, "diameter: " + diameter, new Point(startX, startY +20), Core.FONT_HERSHEY_PLAIN, 1, new Scalar(0, 255, 0));
