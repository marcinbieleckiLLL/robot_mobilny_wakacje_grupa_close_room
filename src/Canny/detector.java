...
public class detector {
    ...
    public void funkcja(int numerKlatki)
    {
        i=numerKlatki;
        this.setLowThreshold(0.5f);
        this.setHighThreshold(1f);
        Image image = null;

        String filePath = "transformationPhotos\\"+i+".jpg";
        ...
        this.setSourceImage(buffered);
        this.process();
        BufferedImage edges = this.getEdgesImage();
        File outputfile = new File("transformationPhotos\\"+i+"o.jpg");
        try {
            ImageIO.write(edges, "jpg", outputfile);
        } catch (IOException e) {
            e.printStackTrace();
        }
        FaceDetection.nextFrame = true;
    }


    public detector(int numerKlatki) {
...
//---------------------------------------------- Tutaj nalezy nastroic filtr Cannego dla wlasnych potrzeb
        setHighThreshold(4.5f);
        setLowThreshold(0.1f);
